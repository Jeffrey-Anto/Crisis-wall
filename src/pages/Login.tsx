...
export function Login() {
  ...
  // BUG-02: Redirect already-authenticated users away from the login page
        ...
        <div className="bg-slate-900/80 py-8 px-4 shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-slate-800 backdrop-blur-xl sm:rounded-2xl sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  placeholder="admin@crisiswall.com"
                />
              </div>
            </div>
            ...
            <div>
              <Button type="submit" className="w-full justify-center shadow-[0_0_15px_rgba(34,211,238,0.2)]" disabled={loading}>
                {loading ? "Authenticating..." : "Sign in to Command"}
              </Button>
            </div>
          </form>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link to="/signup" className="font-medium text-cyan-400 hover:text-cyan-300 hover:underline transition-colors">
                Request Access
              </Link>
            </p>
          </div>
